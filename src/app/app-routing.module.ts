...
const routes: Routes = [
  ...
  { path: 'org-support/details/:id', data: { title: 'Update User - Org Support', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportDetailsComponent },
  { path: 'org-support/confirm/:userName', data: { title: 'Confirm - Update User - Org Support', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportConfirmComponent },
  { path: 'org-support/success/:userName', data: { title: 'Success - Update User - Org Support', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportSuccessComponent },
  { path: 'org-support/error', data: { title: 'Error - Update User - Org Support', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportErrorComponent },
  ...
  { path: 'mfaresetnotification', data: { title: 'Email - MFA Reset' }, pathMatch: 'full', component: SendMFAResetNotificationComponent },
  { path: 'mfaresetnotification/success', data: { title: 'Success - Email - MFA Reset' }, pathMatch: 'full', component: SendMFAResetNotificationSuccessComponent },
