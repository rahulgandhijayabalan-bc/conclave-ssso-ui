...
const routes: Routes = [
  ...
  { path: 'org-support/success/:id', data: { title: 'Success', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportSuccessComponent },
  ...
  { path: 'org-support/success-reset-password/:id', data: { title: 'Success', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportSuccessResetPasswordComponent },
  { path: 'org-support/success-changed-role/:id', data: { title: 'Success', roles: ['ORG_USER_SUPPORT'] }, pathMatch: 'full', canActivate: [AuthGuard, RoleGuard], component: OrgSupportSuccessChangedRoleComponent },
