      ...
      if(this.isServiceVisible){
        this.orgRoles.map((role:any) => {
          ...
          if (!this.isEdit) {
            ...
            let filterRole = this.pendingRoleDetails.find((element: { roleKey: any; }) => element.roleKey == role.RoleGroupNameKey)
          ...
          if (
            role.RoleGroupNameKey == 'ORG_ADMINISTRATOR' &&
            userRole == true &&
